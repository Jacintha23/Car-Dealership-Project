...
public class DealershipApplication
{
    ...
    private void searchByColor()
    {
        UserInterface.displayMessage("\n Search by color");
        UserInterface.displayMessage("--------------------------");
        String color = UserInterface.getUserInputString("Color: ");
        String[] color = { "Red", "Gray", "Black", "White", "Blue", "Silver", "Green", "Tan", "Orange", "Yellow" }

        ArrayList<Vehicle> vehicles = dealership.getVehiclesByColor(String color);
